...
public class ParsedString implements IParsedKeywordString {
    ...
    public enum ArgumentType {
        COMMENT, TABLE, SETTING_KEY, VARIABLE_KEY, NEW_TEST_CASE, NEW_KEYWORD, SETTING_VAL, SETTING_FILE, SETTING_FILE_WITH_NAME_KEY, SETTING_FILE_ARG, SETTING_FILE_WITH_NAME_VALUE, VARIABLE_VAL, KEYWORD_LVALUE, FOR_PART, KEYWORD_CALL, KEYWORD_ARG,
    }
